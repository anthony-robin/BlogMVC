# https://github.com/rails/coffee-rails/issues/36#issuecomment-48191703
...
module ActionView
  class PathResolver < ActionView::Resolver
    ...
    define_method(method_name) do |path, default_formats|
      send(old_method_name, path.gsub(/\.js\.coffee\.erb$/, '.js.coffee'), default_formats)
    end
  end
end
