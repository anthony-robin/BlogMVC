...
RSpec.describe UsersController do
  ...
  describe 'POST #create' do
    ...
    context 'whit valid params' do
      ...
      let(:flash_message) { 'Votre compte a bien été créé' }

      before do
        %i[validate save].each do |method|
          allow_any_instance_of(UserForm).to receive(method) { true }
        end
      end
    ...
    context 'whit invalid params' do
      before do
        allow_any_instance_of(UserForm).to receive(:validate) { false }
      end
  ...
  describe 'PUT #update' do
    ...
    context 'whit valid params' do
      let(:flash_type) { 'notice' }
      let(:flash_message) { 'Votre profil a été modifié' }
